...
- Remove images in vignettes (addressing
  [\#260](https://github.com/ropensci/RSelenium/issues/260))
- Remove dependency on `Rcompression` (addressing
  [\#251](https://github.com/ropensci/RSelenium/issues/251)
  [\#256](https://github.com/ropensci/RSelenium/issues/256))
- Remove the defunct functions: `phantom`, `checkForServer`, and
  `startServer`
- Use
  [`caTools::base64decode`](https://rdrr.io/pkg/caTools/man/base64.html)
  instead of
...
- Styled the package with `styler` package following the tidyverse
  formatting rules
...
- Fix switchToWindow issue in fiefox
  ([\#143](https://github.com/ropensci/RSelenium/issues/143))
- Add a tutorial to allow running RSelenium Tests in Internet Explorer
  (thanks [@zappingseb](https://github.com/zappingseb)
  [\#193](https://github.com/ropensci/RSelenium/issues/193))
...
- Address issue with user/pass credentials being exposed using SauceLabs
  (thanks [@jstockwin](https://github.com/jstockwin)
  [\#131](https://github.com/ropensci/RSelenium/issues/131))
- Cache packages on TRAVIS to reduce runtime (thanks
  [@jstockwin](https://github.com/jstockwin)
  [\#132](https://github.com/ropensci/RSelenium/issues/132))

## RSelenium 1.7.2

- Fixed issue where rsDriver client when failing to open didn’t catch
  error
- Correctly pass the check argument in rsDriver to wdman (thanks
  [@bourdieu](https://github.com/bourdieu)
  [\#123](https://github.com/ropensci/RSelenium/issues/123))
...
- checkForServer and startServer are now defunct. rsDriver is marked as
  a dual replacement. Docker is recommended to run a selenium
  server/browser.
...
- Added a selectTag method to the webElement class see
  [\#108](https://github.com/ropensci/RSelenium/issues/108).
- RSelenium Basics vignette was updated/revised.

## RSelenium 1.6.0

- Moved http package from RCurl to httr see
  [\#106](https://github.com/ropensci/RSelenium/issues/106).
- Removed dependence on rjson. httr incorporates jsonlite.
- Import base64_decode from openssl.
- Fixed issue with attributes.Selenium not firing error see
  [\#109](https://github.com/ropensci/RSelenium/issues/109)
...
- Deprecate startServer and checkForServer (look at processx to manage
  process)
- Use message rather than print (thanks Dean Attali
  [\#88](https://github.com/ropensci/RSelenium/issues/88)) in
  checkForServer. Fix typo in startServer (thanks Charles Thompson
  [\#85](https://github.com/ropensci/RSelenium/issues/85))
...
- startServer utility function now returns a list of function; getpid
  ...
  Dan Tenenbaum [\#67](https://github.com/ropensci/RSelenium/issues/67)
  and Toby Dylan Hocking
  [\#72](https://github.com/ropensci/RSelenium/issues/72)

## RSelenium 1.3.7

- Add fix for multiple/Beta JARS in checkForServer (Thanks Dean Attali
  [\#79](https://github.com/ropensci/RSelenium/issues/79))
- Update reference for Selenium download (Thanks
...
- Add utility function makeFirefoxProfile (Thanks Shan Huang
  [\#24](https://github.com/ropensci/RSelenium/issues/24))
- Fix phantom utility function for OSX (Thanks Carson Sievert
  [\#25](https://github.com/ropensci/RSelenium/issues/25))
...
- Fixed file paths in startServer for windows (Thanks
  [@mnel](https://github.com/mnel)
  [\#22](https://github.com/ropensci/RSelenium/issues/22))
...
- Update reference classes to use `@field` and inline docstrings for
  methods
- Allow partial string matching on the `using` argument of the
  findElement and findElements method from the remoteDriver class.
- Allow partial string matching on the `using` argument of the
  findChildElement and findChildElements method from the webElement
  class.
...
- Add additional support for encoding (thanks to Nicola Logrillo issue
  [\#16](https://github.com/ropensci/RSelenium/issues/16))
- Add file argument to screenshot method in remoteDriver class to allow
